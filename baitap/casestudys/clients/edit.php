...
$items = $stmt->fetch();
 ...
 if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($err)){
 $sql = "UPDATE clients SET `name_client` = '$name', `address` = '$address', `phone` = '$phone'  WHERE id_client='$id'";
    ...
    <div class="container">
        <form method="post" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="" class="form-control" placeholder="Tên" value="<?php echo $items->name_client; ?>">
