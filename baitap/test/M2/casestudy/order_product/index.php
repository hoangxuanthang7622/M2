                        ...
                        <tbody>
                            <tr>
                               ...
                               <td width="250px" >
                                    ...
                                    <a class="btn btn-danger" href="delete.php?id=<?=$row->id_orders_detail?>&id1=<?=$max?>" onclick="return confirm('Bạn có chắc khách hàng yêu cầu hủy đơn không?');"><i>Hủy Đơn</i></a>
                                    </td>
                            </tr>
                        </tbody>
                    <?php } ?>
